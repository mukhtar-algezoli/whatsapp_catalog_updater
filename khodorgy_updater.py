            ...
            for i in range(len(products_ar)):
                if products_en[i]["category_id"] == str(index):
                    ...
                    if product is not None:
                        ...
                        print(float(products_ar[i]["price"]) * khodorgy_unit_value(products_ar[i]["unit_id"]))
                        ...
                        product_dict["categories"] = str(category["_id"]) if category else [ObjectId(str(output.inserted_id))]
                        product_dict["variants"] = []
